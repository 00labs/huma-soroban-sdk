...
export const networks = {
  unknown: {
    ...
    contractId: "CB6W2Z5ZRKLUL5A3OIHD7IAYMFLNRJ2VHFEXG7TSBB4LFE3YYSJII5JG",
  },
} as const;
...
export type CreditDataKey =
  ...
  | { tag: "CreditRecord"; values: readonly [Buffer] }
  | { tag: "DueDetail"; values: readonly [Buffer] }
  | { tag: "Borrower"; values: readonly [Buffer] };
...
export interface Client {
  ...
  initialize: (
    {
      ...
      credit_manager,
      pool_storage,
    }: { credit: string; credit_manager: string; pool_storage: string },
    options?: {
      /**
   ...
   */
  set_credit_config: (
    { credit_hash, cc }: { credit_hash: Buffer; cc: CreditConfig },
    options?: {
      /**
       * The fee to pay for the transaction. Default: BASE_FEE
       */
  ...
  set_credit_record: (
    {
      ...
      credit_hash,
      cr,
    }: { caller: string; credit_hash: Buffer; cr: CreditRecord },
    options?: {
      /**
       * The fee to pay for the transaction. Default: BASE_FEE
       */
  ...
  set_due_detail: (
    {
      ...
      credit_hash,
      dd,
    }: { caller: string; credit_hash: Buffer; dd: DueDetail },
    options?: {
      /**
       * The fee to pay for the transaction. Default: BASE_FEE
       */
   ...
   */
  set_borrower: (
    { credit_hash, addr }: { credit_hash: Buffer; addr: string },
    options?: {
      /**
       * The fee to pay for the transaction. Default: BASE_FEE
       */
   ...
   */
  get_credit_config: (
    { credit_hash }: { credit_hash: Buffer },
    options?: {
      /**
       * The fee to pay for the transaction. Default: BASE_FEE
       */
...
export class Client extends ContractClient {
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([
        "AAAAAgAAAAAAAAAAAAAADUNsaWVudERhdGFLZXkAAAAAAAADAAAAAAAAAAAAAAAGQ3JlZGl0AAAAAAAAAAAAAAAAAA1DcmVkaXRNYW5hZ2VyAAAAAAAAAAAAAAAAAAALUG9vbFN0b3JhZ2UA",
