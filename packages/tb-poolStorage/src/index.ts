...
export interface Client {
   ...
   */
  initialize: ({addrs, tranche_addrs, tranches_policy}: {addrs: Array<string>, tranche_addrs: Array<Option<string>>, tranches_policy: TranchesPolicyType}, options?: {
    /**
   ...
   */
  set_contract_addrs: ({pool, pool_manager, credit}: {pool: string, pool_manager: string, credit: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  set_huma_config: ({huma_config, huma_owner, sentinel}: {huma_config: string, huma_owner: string, sentinel: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  set_pool_owner: ({pool_owner}: {pool_owner: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  set_pool_owner_treasury: ({pool_owner_treasury}: {pool_owner_treasury: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  set_evaluation_agent: ({ea}: {ea: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  set_epoch: ({epoch}: {epoch: Epoch}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  set_lp_config: ({liquidity_cap, max_senior_junior_ratio, fixed_senior_yield_bps, tranches_risk_adjustment_bps, withdrawal_lockout_period_days, auto_redemption_after_lockup}: {liquidity_cap: u128, max_senior_junior_ratio: u32, fixed_senior_yield_bps: u32, tranches_risk_adjustment_bps: u32, withdrawal_lockout_period_days: u32, auto_redemption_after_lockup: boolean}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  set_tranches_policy_type: ({policy_type}: {policy_type: TranchesPolicyType}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  update_assets: ({caller, tranche_assets}: {caller: string, tranche_assets: TrancheAssets}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  update_admin_fees_reserve: ({amount, increase}: {amount: u128, increase: boolean}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  distribute_profit_to_tranches: ({profit, admin_fees}: {profit: u128, admin_fees: u128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  refresh_yield_tracker: ({tranche_assets}: {tranche_assets: TrancheAssets}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  check_pool_owner_liquidity_req: ({tranche_vault, balance}: {tranche_vault: string, balance: u128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  check_ea_liquidity_req: ({tranche_vault, balance}: {tranche_vault: string, balance: u128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  get_pool_owner_min_liquidity_req: ({index}: {index: u32}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  get_ea_min_liquidity_req: ({index}: {index: u32}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAAKaW5pdGlhbGl6ZQAAAAAAAwAAAAAAAAAFYWRkcnMAAAAAAAPqAAAAEwAAAAAAAAANdHJhbmNoZV9hZGRycwAAAAAAA+oAAAPoAAAAEwAAAAAAAAAPdHJhbmNoZXNfcG9saWN5AAAAB9AAAAASVHJhbmNoZXNQb2xpY3lUeXBlAAAAAAAA",
