...
export const networks = {
  testnet: {
    ...
    contractId: "CBS4UVM2LAMXGJFEDB3D2F2C7RJDPKA7OMQWHCBK5WN32Q6GNQUJWML7",
  }
} as const
...
export type ClientDataKey = {tag: "PoolManager", values: void} | {tag: "PoolStorage", values: void};
...
export const Errors = {
  ...
  413: {message:"YieldDistributingLenderRequired"},

  414: {message:"InsufficientBalanceForYieldWithdrawal"},
...
export type TrancheTokenDataKey = {tag: "Balance", values: readonly [string]} | {tag: "TotalSupply", values: void};
...
export interface YieldDistributingLenderAddedEvent {
  account: string;
}


export interface YieldDistributingLenderRemovedEvent {
  account: string;
}
...
export interface YieldsWithdrawnEvent {
  account: string;
  shares_burned: u128;
  yields: u128;
}
...
export type TrancheVaultDataKey = {tag: "TrancheIndex", values: void} | {tag: "ApprovedLender", values: readonly [string]} | {tag: "DepositRecord", values: readonly [string]} | {tag: "LenderRedemptionRecord", values: readonly [string]} | {tag: "EpochRedemptionSummary", values: readonly [u64]} | {tag: "YieldDistributingLender", values: readonly [string]};
...
export interface Client {
   ...
   */
  initialize: ({decimals, name, symbol, pool_storage, pool_manager, index}: {decimals: u32, name: string, symbol: string, pool_storage: string, pool_manager: string, index: u32}, options?: {
    /**
   ...
   */
  set_contract_addrs: ({caller, pool_storage, pool_manager}: {caller: string, pool_storage: string, pool_manager: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  add_approved_lender: ({caller, lender}: {caller: string, lender: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
  ...
  /**
   * Construct and simulate a add_yield_distributing_lender transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  add_yield_distributing_lender: ({caller, lender}: {caller: string, lender: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
  ...
  /**
   * Construct and simulate a remove_yield_distributing_lender transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  remove_yield_distributing_lender: ({caller, lender}: {caller: string, lender: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
  ...
  /**
   * Construct and simulate a withdraw_yields transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  withdraw_yields: ({lender}: {lender: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  add_redemption_request: ({caller, lender, shares}: {caller: string, lender: string, shares: u128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
  ...
  /**
   * Construct and simulate a is_yield_distributing_lender transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  is_yield_distributing_lender: ({account}: {account: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  transfer: ({_from, _to, _amount}: {_from: string, _to: string, _amount: i128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  burn: ({_from, _amount}: {_from: string, _amount: i128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAQAAAAAAAAAAAAAAIVRyYW5jaGVWYXVsdEFkZHJlc3Nlc0NoYW5nZWRFdmVudAAAAAAAAAIAAAAAAAAADHBvb2xfbWFuYWdlcgAAABMAAAAAAAAADHBvb2xfc3RvcmFnZQAAABM=",
        ...
        "AAAAAAAAAAAAAAAdYWRkX3lpZWxkX2Rpc3RyaWJ1dGluZ19sZW5kZXIAAAAAAAACAAAAAAAAAAZjYWxsZXIAAAAAABMAAAAAAAAABmxlbmRlcgAAAAAAEwAAAAA=",
        "AAAAAAAAAAAAAAAgcmVtb3ZlX3lpZWxkX2Rpc3RyaWJ1dGluZ19sZW5kZXIAAAACAAAAAAAAAAZjYWxsZXIAAAAAABMAAAAAAAAABmxlbmRlcgAAAAAAEwAAAAA=",
        ...
        "AAAAAAAAAAAAAAAPd2l0aGRyYXdfeWllbGRzAAAAAAEAAAAAAAAABmxlbmRlcgAAAAAAEwAAAAA=",
        ...
        "AAAAAAAAAAAAAAAcaXNfeWllbGRfZGlzdHJpYnV0aW5nX2xlbmRlcgAAAAEAAAAAAAAAB2FjY291bnQAAAAAEwAAAAEAAAAB",
        ...
        "",
        ...
        "AAAAAQAAAAAAAAAAAAAAIVlpZWxkRGlzdHJpYnV0aW5nTGVuZGVyQWRkZWRFdmVudAAAAAAAAAEAAAAAAAAAB2FjY291bnQAAAAAEw==",
        "AAAAAQAAAAAAAAAAAAAAI1lpZWxkRGlzdHJpYnV0aW5nTGVuZGVyUmVtb3ZlZEV2ZW50AAAAAAEAAAAAAAAAB2FjY291bnQAAAAAEw==",
        ...
        "AAAAAQAAAAAAAAAAAAAAFFlpZWxkc1dpdGhkcmF3bkV2ZW50AAAAAwAAAAAAAAAHYWNjb3VudAAAAAATAAAAAAAAAA1zaGFyZXNfYnVybmVkAAAAAAAACgAAAAAAAAAGeWllbGRzAAAAAAAK",
        ...
        "",
  ...
  public readonly fromJSON = {
    initialize: this.txFromJSON<null>,
        ...
        add_yield_distributing_lender: this.txFromJSON<null>,
        remove_yield_distributing_lender: this.txFromJSON<null>,
        make_initial_deposit: this.txFromJSON<u128>,
        deposit: this.txFromJSON<u128>,
        withdraw_yields: this.txFromJSON<null>,
        ...
        is_yield_distributing_lender: this.txFromJSON<boolean>,
