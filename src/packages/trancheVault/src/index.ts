...
export type ClientDataKey = {tag: "Pool", values: void} | {tag: "PoolManager", values: void} | {tag: "PoolStorage", values: void} | {tag: "UnderlyingToken", values: void};
...
export type TrancheVaultDataKey = {tag: "TrancheIndex", values: void} | {tag: "ApprovedLender", values: readonly [string]} | {tag: "DepositRecord", values: readonly [string]} | {tag: "LenderRedemptionRecord", values: readonly [string]} | {tag: "EpochRedemptionSummary", values: readonly [u64]};
...
export interface Client {
   ...
   */
  initialize: ({name, symbol, underlying_token, pool, pool_storage, pool_manager, index}: {name: string, symbol: string, underlying_token: string, pool: string, pool_storage: string, pool_manager: string, index: u32}, options?: {
    /**
...
export class Client extends ContractClient {
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAgAAAAAAAAAAAAAADUNsaWVudERhdGFLZXkAAAAAAAAEAAAAAAAAAAAAAAAEUG9vbAAAAAAAAAAAAAAAC1Bvb2xNYW5hZ2VyAAAAAAAAAAAAAAAAC1Bvb2xTdG9yYWdlAAAAAAAAAAAAAAAAD1VuZGVybHlpbmdUb2tlbgA=",
