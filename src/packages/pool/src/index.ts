...
export type ClientDataKey = {tag: "HumaConfig", values: void} | {tag: "PoolStorage", values: void} | {tag: "Credit", values: void} | {tag: "PoolManager", values: void};
...
export interface Client {
   ...
   */
  initialize: ({huma_config, pool_manager, pool_storage, credit, tranches_policy}: {huma_config: string, pool_manager: string, pool_storage: string, credit: string, tranches_policy: TranchesPolicyType}, options?: {
    /**
   ...
   */
  set_huma_config: ({addr, caller}: {addr: string, caller: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  set_pool_storage: ({addr, caller}: {addr: string, caller: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAgAAAAAAAAAAAAAADUNsaWVudERhdGFLZXkAAAAAAAAEAAAAAAAAAAAAAAAKSHVtYUNvbmZpZwAAAAAAAAAAAAAAAAALUG9vbFN0b3JhZ2UAAAAAAAAAAAAAAAAGQ3JlZGl0AAAAAAAAAAAAAAAAAAtQb29sTWFuYWdlcgA=",
