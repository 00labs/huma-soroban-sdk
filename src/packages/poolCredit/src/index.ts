...
export type ClientDataKey = {tag: "Pool", values: void} | {tag: "PoolStorage", values: void} | {tag: "CreditStorage", values: void} | {tag: "UnderlyingToken", values: void};
...
export interface Client {
   ...
   */
  initialize: ({pool, pool_storage, credit_storage, underlying_token}: {pool: string, pool_storage: string, credit_storage: string, underlying_token: string}, options?: {
    /**
...
export class Client extends ContractClient {
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAgAAAAAAAAAAAAAADUNsaWVudERhdGFLZXkAAAAAAAAEAAAAAAAAAAAAAAAEUG9vbAAAAAAAAAAAAAAAC1Bvb2xTdG9yYWdlAAAAAAAAAAAAAAAADUNyZWRpdFN0b3JhZ2UAAAAAAAAAAAAAAAAAAA9VbmRlcmx5aW5nVG9rZW4A",
